  ...
  function renderActionMenu(m: Member) {
    ...
    return (
      ...
      >
        ...
        >
          <UserCheck size={14} /> Consulter le profil
        </Link>
        {actions.map((action) => {
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                ...
                <tbody>
                  {rows.map((m) => (
                    <tr key={m.id} className="border-b border-slate-100 last:border-0 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-950/60 transition">
